                    ...
                    {categories.map(cat => (
                        <tr key={cat.id} className="hover:bg-gray-50">
                            ...
                            <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <button onClick={() => openEditModal(cat)} className="text-indigo-600 hover:text-indigo-900 mr-4"><Edit size={18}/></button>
                ...
                <div className="bg-white rounded-xl shadow-xl w-full max-w-md">
                    ...
                    <form onSubmit={handleSubmit} className="p-6 space-y-4">
                        <div>
                            ...
                            <input required type="text" value={code} onChange={e => setCode(e.target.value)} className="mt-1 w-full border rounded p-2"/>
                        </div>
                        <div>
                            <label className="block text-sm font-medium text-gray-700">Tên danh mục</label>
                            <input required type="text" value={name} onChange={e => setName(e.target.value)} className="mt-1 w-full border rounded p-2"/>
                        </div>
                        <div>
