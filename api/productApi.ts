...
export const productApi = {
  ...
  getById: async (id: number): Promise<Product | null> => {
    const res = await axiosClient.post("/product/get-by-id", null, {
      params: {
        id,
      },
    });
  ...
  update: async (data: UpdateProductRequest): Promise<Product> => {
    const res = await axiosClient.post("/product/update", data);
    return res.data;
  },

  delete: async (id: number): Promise<number> => {
    const res = await axiosClient.post("/product/delete", null, {
      params: {
        id,
      },
    });
