  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <div className="flex flex-grow max-w-7xl w-full mx-auto">
        ...
        {/* Content Area */}
        <main
          className={`flex-grow px-4 sm:px-6 lg:px-8 py-8 w-full ${
            isStaff || isAdmin ? "bg-gray-50" : ""
          }`}
        >
          {children}
        </main>
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div>
                  ...
                  <p className="text-gray-500 text-sm">
                    Hệ thống cửa hàng thú cưng và dịch vụ chăm sóc hàng đầu Việt
                    Nam.
                  </p>
                </div>
                  ...
                  <div className="space-y-3 text-sm text-gray-600">
                    <div>
                      <p className="font-medium text-gray-800">
                        Shop có ship tỉnh không?
                      </p>
                      <p className="text-xs">
                        Có, chúng tôi vận chuyển toàn quốc.
                      </p>
                    </div>
                    <div>
                      <p className="font-medium text-gray-800">
                        Thú cưng có giấy tờ không?
                      </p>
                      <p className="text-xs">
                        Tất cả thú cưng đều có giấy chứng nhận sức khỏe và nguồn
                        gốc.
                      </p>
                    </div>
                    <div>
                      <p className="font-medium text-gray-800">
                        Đặt lịch spa cần báo trước bao lâu?
                      </p>
